...
int main()	
{
	...
	cout << endl;
	cout << "\tPTR: The address which is in the pointer: " << ptr << endl;
	cout << "\tPTR: The value that the PTR's address is poining to: " << *ptr << endl;
	cout << "\tPTR: The address of PTR: " << &ptr << endl;
