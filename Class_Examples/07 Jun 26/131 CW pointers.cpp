...
int main()	
{
	...
	{
		cout << "\tValue of [" << ctr << "]: " << value[ctr] << endl;
		cout << "\tAddress of [" << ctr << "]: " << &value[ctr] << endl;
	}
	
	cout << "\n\tPTR:Stored address: "  << ptr << endl;
	cout << "\n\tPTR:Value of 1st one "  << *ptr << endl;
	
	ptr++;
	
	cout << "\n\tPTR:Stored address: "  << ptr << endl;
	cout << "\n\tPTR:Value of 2nd one "  << *ptr << endl;
