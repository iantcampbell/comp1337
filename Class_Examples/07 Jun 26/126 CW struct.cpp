...
void populateStudents(Students[]);
...
int main()	
{
	...
	Students myStudents[3];
	
	populateStudents(myStudents);
...
/*
*/
void displayStudents(Students myStudents[])
{
	cout << "\n" << dashes << endl;
...
/*
*/
void populateStudents(Students myStudents[])
{
	for (int ctr = 0; ctr < 3; ctr++)
	{
