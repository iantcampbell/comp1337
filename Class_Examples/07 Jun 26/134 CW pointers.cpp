...
int main()	
{
	...
	// Dynamicall allocate a memory space...  programers have control over the memory
	float *value = new float(12.34);
	
	cout << "\tAddress: Value: " << value << endl; // address
	cout << "\tValue: " << *value << endl; // address
	
	delete value; 	// releaing the memory
