...
{
	cout << "\n" << dashes << endl;
	cout << "\tName: " << myStudents.name << endl;
	cout << "\tScore for exam 1: " << myStudents.examOne << endl;
	cout << "\tScore for exam 2: " << myStudents.examTwo << endl;
	cout << "\tScore for exam 3: " << myStudents.examThree << endl;
}
...
{
	myStudents.name = getStringData("\tEnter name: ");
	myStudents.examOne = getFloatData("\tEnter score for exam 1: ");
	myStudents.examTwo = getFloatData("\tEnter score for exam 2: ");
	myStudents.examThree = getFloatData("\tEnter score for exam 3: ");
}
