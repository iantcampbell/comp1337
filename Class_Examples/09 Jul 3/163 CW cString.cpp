...
int main()	
{
	...
	cout << "\tEnter a string: ";
	cin.getline(str1, 10);  // proceed with blank or 9 places
	
	cout << "\tEnter another string: ";
	cin.getline(str2, 10);  // proceed with blank or 9 places
	
	strcat(str1, str2);  // str1 = str1 + str2 (STRINGS)
	cout <<"\tAfter concatenation (strcat) str2: " << str2 << endl;
	cout <<"\tAfter concatenation (strcat) str1: " << str1 << endl;
