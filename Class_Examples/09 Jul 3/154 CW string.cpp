...
int main()	
{
	...
	//
	string str1 = "Quick of Mind! Strong of Body! Pure of Heart";
	
	int position;
	
	position = str1.find("Quick");
	cout << "\tQuick is found in position: " << position << endl;
	
	position = str1.find("Body");
	cout << "\tBody is found in position: " << position << endl;
	
	position = str1.find("Ally");
	cout << "\tAlly is found in position: " << position << endl;
