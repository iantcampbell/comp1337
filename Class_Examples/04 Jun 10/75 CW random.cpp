...
int main()	
{
	...
	// initialize the random seed.. seed >> new sequence of pseudo-radom nubers to be returned using suucessive calss to rand
	srand(time(0));
	
	int randomNumber;
	
	// flip a coin: 0 means true 1 means false
		cout << "\n\tgenerate integers from 1 to 6"  << endl;
	for (int ctr = 0; ctr < 10; ctr++)
	{
		...
		if (randomNumber == 0)
		{
			cout << "\tIt is Head: " << randomNumber << endl;
		}
		else
		{
			cout << "\tIt is Tail: " << randomNumber << endl;
		}
	}
