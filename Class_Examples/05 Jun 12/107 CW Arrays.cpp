...
void displayTemperature(float[][7], float, float, float);
void findAverageTemperature(float[][7], float &);
void findMaxTemperature(float[][7], float &);
void findMinTemperature(float[][7], float &);
...
int main()	
{
	...
	findMaxTemperature(temperature, maxTemperature);
	findMinTemperature(temperature, minTemperature);
	
	displayTemperature(temperature, avgTemperature, maxTemperature, minTemperature);
...
void findMinTemperature(float temperature[][7], float &minTemperature)
{
	...
	for (int week = 0; week < 3; week++)
	{
		...
		for (int day = 0; day < 7; day++)
		{
			...
			if (temperature[week][day] < minTemperature)
			{
				minTemperature = temperature[week][day]	;
			}
...
/*
	name: 	findMaxTemperature()
	input: 	parameter(arguments): flaot array
	output: None
	process: loop for 7 days to get the temperature
	objectives: temperature for a week
*/
void findMaxTemperature(float temperature[][7], float &maxTemperature)
{
	maxTemperature = temperature[0][0];
	...
	for (int week = 0; week < 3; week++)
	{
		...
		for (int day = 0; day < 7; day++)
		{
			...
			if (temperature[week][day] > maxTemperature)
			{
				maxTemperature = temperature[week][day]	;
			}
...
/*
	...
	objectives: temperature for a week
*/
void displayTemperature(float temperature[][7], float avgTemperature, float maxTemperature, float minTemperature)
{
	string message;
