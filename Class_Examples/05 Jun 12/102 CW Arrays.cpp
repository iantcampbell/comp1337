...
void displayTemperature(float[][7]);
...
*/
void displayTemperature(float temperature[][7])
{
	string message;
	...
	{
		cout << "\tTemperature for each day of the week# " << week + 1 << endl;
		
		for (int day = 0; day < 7; day++)
		{
			message = "\t\t" + weekDays[day] + ": ";
			cout << message << temperature[week][day] << endl;
