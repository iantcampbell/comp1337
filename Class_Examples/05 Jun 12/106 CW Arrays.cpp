...
void displayTemperature(float[][7], float, float);
...
int main()	
{
	...
	displayTemperature(temperature, avgTemperature, maxTemperature);
...
/*
	...
	objectives: temperature for a week
*/
void displayTemperature(float temperature[][7], float avgTemperature, float maxTemperature)
{
	string message;
