...
int main()	
{
	...
	// get a float value betwee 1 and 10
	// if out of range error message
	// if non-numeric erro message
	
	int value;
	value = getIntegerData("\tEnter an integer between 1 and 10 (inclusive)): ");
