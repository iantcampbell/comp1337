...
void displayEmployee(Employee, float);
void findGrossPay(Employee, float &);
...
int main()	
{
	...
	myEmployee = populateEmployee();
	
	findGrossPay(myEmployee, grossPay);

	displayEmployee(myEmployee, grossPay);
...
*/
void findGrossPay(Employee myEmployee, float & grossPay)
{
	float overTime;
	
	if (myEmployee.hoursWorked <= 40)
	{
		grossPay = myEmployee.hoursWorked * myEmployee.wage;
	}
	else
	{
		overTime = myEmployee.hoursWorked - 40;
		grossPay = 40 * myEmployee.wage + overTime * myEmployee.wage * 1.5;
	}
...
/*
	...
	objectives: gets char
*/
void displayEmployee(Employee myEmployee, float grossPay)
{
...
Employee populateEmployee()
{
	...
	tempEmploy.hoursWorked = getFloatData("\tEnter hours worked: ");
	tempEmploy.wage = getFloatData("\tEnter wage: $: ");
