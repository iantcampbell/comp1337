...
{
	cout << "\tExam 1: " << myStudent.examScoreOne << endl;
	cout << "\tExam 2: " << myStudent.examScoreTwo << endl;
	cout << "\tExam 3: " << myStudent.examScoreThree << endl;
}
...
Student populateStudent()
{
	...
	tempStudent.examScoreOne = getFloatData("\tEnter score for exam 1: ");
	tempStudent.examScoreTwo = getFloatData("\tEnter score for exam 2: ");
	tempStudent.examScoreThree = getFloatData("\tEnter score for exam 3: ");
