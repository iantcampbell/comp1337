...
/*
	name: 	findLetterGrade()
	input: 	parameter(arguments): string
	output: return char
	process: gets and entry char
	objectives: gets char
*/
void findLetterGrade(Student & myStudent)
{
	if (myStudent.examAverage >= 90)
	{
		myStudent.letterGrade = 'A';
	}
	else if (myStudent.examAverage >= 80)
	{
		myStudent.letterGrade = 'B';
	}
	else if (myStudent.examAverage >= 70)
	{
		myStudent.letterGrade = 'C';
	}
	else if (myStudent.examAverage >= 60)
	{
...
void displayStudent(Student myStudent)
{
	...
	cout << "\tLetter Grade: " << myStudent.letterGrade << endl;
}
