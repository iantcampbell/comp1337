...
*/
void findGrossPay(Employee & myEmployee)
{
	float overTime;
	
	if (myEmployee.hoursWorked <= 40)
	{
		myEmployee.grossPay = myEmployee.hoursWorked * myEmployee.wage;
	}
	else
	{
		overTime = myEmployee.hoursWorked - 40;
		myEmployee.grossPay = 40 * myEmployee.wage + overTime * myEmployee.wage * 1.5;
	}
...
Employee populateEmployee()
{
	...
	tempEmploy.name = getStringData("\tEnter name: ");
