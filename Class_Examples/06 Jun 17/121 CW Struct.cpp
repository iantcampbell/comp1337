...
{
	cout << "\n\n\tMovie name: "  << myMovies.name << endl;
	cout << "\tNumber of adult tickets: " << myMovies.adultTicket << endl;
	cout << "\tNumber of chilren tckets: " << myMovies.childrenTicket << endl;
}
...
void populateMovies(Movies & myMovies)
{
	...
	myMovies.name = getStringData("\tEnter movies name: ");
	myMovies.adultTicket = getIntegerData("\tEnter number of adult tickets: ");
	myMovies.childrenTicket = getIntegerData("\tEnter number of children tickets: ");
