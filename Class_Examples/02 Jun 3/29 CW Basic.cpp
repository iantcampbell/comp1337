...
float findAverageExamScore(int, int, int);
...
int main()	
{
    ...
    // user entry of var
    examScoreOne = getIntegerData("\tEnter the first exam score: ");
    examScoreTwo = getIntegerData("\tEnter the second exam score: ");
    examScoreThree = getIntegerData("\tEnter the third exam score: ");
    
    // get average
    averageExamScore = findAverageExamScore(examScoreOne, examScoreTwo, examScoreThree);
...
*/
float findAverageExamScore(int examScoreOne, int examScoreTwo, int examScoreThree)
{
	float average;
	average = (float) (examScoreOne + examScoreTwo + examScoreThree) / 3.0;
