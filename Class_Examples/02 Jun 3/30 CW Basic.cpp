...
void projectStart();
void projectEnd();
void displayResults(float, float, float, float);
int getIntegerData(string);
float getFloatData(string);

float findAverageExamScore(float, float, float);
...
*/
float findAverageExamScore(float examScoreOne, float examScoreTwo, float examScoreThree)
{
	float average;
...
*/
void displayResults(float examScoreOne, float examScoreTwo, float examScoreThree, float averageExamScore)
{
	cout << "\n\tResult" << endl;
    cout << "--------------------------" << endl;
