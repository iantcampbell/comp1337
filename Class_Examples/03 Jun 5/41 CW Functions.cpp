...
int main()	
{
	...
	cout << "\tBefore calling function value1 = " << value1 << " and value2 = " << value2 << " and value3 = " << value3 << endl;
	checkValues(value1, value2, value3);
	cout << "\tBefore after function value1 = " << value1 << " and value2 = " << value2 << " and value3 = " << value3 << endl; 
...
/*
	...
	objectives: 
*/
void checkValues(int &val1=40, int &val2=30, int val3=30)
{ 
	val2 = val1 + val2;  // 30
	val1 = val1 + val2; // 30+10>40
	val3 = val2 + val3 + val1; //30_40_30>100
}
