...
int main()	
{
    ...
    // user entry of var
    grade = getIntegerData("\tEnter a value: ");
    
    // Objective
    // display letter grade
    if (grade >= 90)
    {
    	cout << "\tGrade " << grade << " is A" << endl;
	}
	else if (grade >= 80)
    {
    	cout << "\tGrade " << grade << " is B" << endl;
	}
	else if (grade >= 70)
    {
    	cout << "\tGrade " << grade << " is C" << endl;
	}
	else if (grade >= 60)
    {
    	cout << "\tGrade " << grade << " is D" << endl;
	}    
	else
    {
    	cout << "\tGrade " << grade << " is F" << endl;
	}
