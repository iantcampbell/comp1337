...
int main()	
{
	...
	char selection;
   	...
   	// Project 5
    // user entry of var
    selection = getCharData("\tMake your selection (T)exas | (O) for Out of State | (F)oreign | (E)xit): ");
    
    if (selection == 'T')
    {
    	cout << "\tMailing to Texas" << endl;
	}
	else if (selection == 'O')
    {
    	cout << "\tMailing to Out of State" << endl;
	}
	else if (selection == 'F')
    {
    	cout << "\tMailing to Foreign" << endl;
	}
	else if (selection == 'E')
    {
    	cout << "\tExit USPS" << endl;
