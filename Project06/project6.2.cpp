...
void populateStudent(Student *myStudent, int studentCount)
{
	for (int studentIndex = 0; studentIndex < studentCount; studentIndex++)
	{
		...
		if (myStudent[studentIndex].examScores[1] > myStudent[studentIndex].examScores[3])
		{
			swap(myStudent[studentIndex].examScores[1], myStudent[studentIndex].examScores[3]);
		}
		
		if (myStudent[studentIndex].examScores[1] > myStudent[studentIndex].examScores[2])
		{
			swap(myStudent[studentIndex].examScores[1], myStudent[studentIndex].examScores[2]);
		}
		
		if (myStudent[studentIndex].examScores[2] > myStudent[studentIndex].examScores[3])
		{
			swap(myStudent[studentIndex].examScores[2], myStudent[studentIndex].examScores[3]);
		}
		
		myStudent[studentIndex].average = (myStudent[studentIndex].examScores[1] + myStudent[studentIndex].examScores[2] + myStudent[studentIndex].examScores[3])/300;
	}	
}
