...
void displayStudent(Student *myStudent, int studentCount)
{
	...
	cout << dashes << endl;
	cout << "\tName" << "Scores" << "Letter Grade" << endl;
	cout << dashes << endl;
	...
	for (int ctr = 0; ctr < studentCount; ctr++)
	{
		...
		letterGrade = getLetterGrade(studentAverage);
		cout << myStudent->name << myStudent->examScores[0] << myStudent->examScores[1] << myStudent->examScores[2] << letterGrade << endl;
...
char getLetterGrade(float studentAverage)
{
